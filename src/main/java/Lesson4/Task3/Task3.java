...
public class Task3 {
     ...
     */
    static RequestHandler commonRequestHandler = wrapInTransactionTag.concatHandler(createDigest.concatHandler(wrapInRequestTag));
    ...
    interface RequestHandler {
        ...
        default RequestHandler concatHandler(RequestHandler newRequestHandler) {
            return (Request req) -> newRequestHandler.handle(this.handle(req));
        }
    }
