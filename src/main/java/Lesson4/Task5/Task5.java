 ...
 */
public class Task5 {
    static String[] words = {"aaaa", "aaa", "a", "aa", "loop", "pool", "noon"};
    static Map<Boolean, List<String>> palindromeOrNoMap;

    public static void main(String[] args) {
        System.out.println(palindromeDetected());
    }

    public static Map<Boolean, List<String>> palindromeDetected() {
        palindromeOrNoMap = Arrays.stream(words)
